...
import frc.robot.commands.BottomAlgaeIntakeInAuto;
import frc.robot.commands.BottomAlgaeIntakeOut;
import frc.robot.commands.BottomAlgaeIntakeOutAuto;
...
import frc.robot.commands.CoralInAuto;
import frc.robot.commands.CoralOut;
import frc.robot.commands.CoralOutAuto;
import frc.robot.commands.CoralOutAutoStop;
...
import frc.robot.commands.TopIntakeAngleBarge;
import frc.robot.commands.TopIntakeAngleDown;
import frc.robot.commands.TopIntakeAngleFeed;
import frc.robot.commands.TopIntakeAngleFeedAuto;
import frc.robot.commands.TopIntakeAngleShoot;
import frc.robot.commands.TopIntakeAngleShootAuto;
...
IntakeSubsystem intake = new IntakeSubsystem();
    ...
    public RobotContainer() {
      ...
      private void registerPathPlannerCommands() {
         NamedCommands.registerCommand("L1", new L1Auto(lift)); 
         ...
         NamedCommands.registerCommand("CoralIn", new CoralInAuto(intake));
        // NamedCommands.registerCommand("CoralStop", new CoralStop(intake));
         NamedCommands.registerCommand("CoralOutStop", new CoralOutAutoStop(intake));
         NamedCommands.registerCommand("CoralOut", new CoralOutAuto(intake));
         ...
         NamedCommands.registerCommand("TopIntakeAngleFeed", new TopIntakeAngleFeedAuto(intake));
         NamedCommands.registerCommand("TopIntakeAngleShoot", new TopIntakeAngleShootAuto(intake));
         NamedCommands.registerCommand("BottomAlgeaIntakeIn", new BottomAlgaeIntakeInAuto(intake));
         NamedCommands.registerCommand("BottomAlgeaIntakeOut", new BottomAlgaeIntakeOutAuto(intake));
    ...
    AutonChooser = AutoBuilder.buildAutoChooser("OnePieceSameSideAuton");
    ...
    joystick.pov(180).whileTrue(drivetrain.applyRequest(() ->
        ...
        buttonBoard.button(2).whileTrue(Commands.parallel (new L4(lift), new TopIntakeAngleBarge(intake)));
